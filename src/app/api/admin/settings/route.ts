...
// ------------------------------------------------------------------
// GET → Obtener configuración del sitio desde Firestore
// ------------------------------------------------------------------
export async function GET() {
  try {
    ...
    // Si no existe, inicializamos el documento con valores por defecto
    if (!snapshot.exists()) {
...
// ------------------------------------------------------------------
// PUT → Guardar ajustes del sitio en Firestore
// ------------------------------------------------------------------
